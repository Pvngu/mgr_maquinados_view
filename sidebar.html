    ...
    <div class="home">
        ...
        <dialog class="settingsModal modal">
            <div class="modalHeader">
                <h1>Configuracion</h1>
                <img class = "closeBtnModalS modalX" src="assets/images/close_button.png" alt="close button">
            </div>
        ...
        <dialog class="logoutModal modal">
            <div class="modalHeader">
                <h1>Cerrar sesion</h1>
                <img class = "closeBtnModalL modalX" src="assets/images/close_button.png" alt="close button">
            </div>
        ...
        <dialog class="accountStgModal modal">
            <div class="modalHeader">
                ...
                <img class = "closeBtnModalAS modalX" src="assets/images/close_button.png" alt="close button">
            </div>
        ...
        <dialog class="aboutUsModal modal">
                <div class="modalHeader">
                    ...
                    <img class = "closeBtnModalAU modalX" src="assets/images/close_button.png" alt="close button">
                </div>
